...
public class AddFriendActivity extends AppCompatActivity {
    ...
    private void findViews() {
        ...
        imageback = findViewById(R.id.iamgeback_icon);
        toolbar = findViewById(R.id.toolbar);
        nameText = findViewById(R.id.user_name);
        genderImage = findViewById(R.id.gender_img);
        accountText = findViewById(R.id.user_account);
        toggleLayout = findViewById(R.id.toggle_layout);
        addFriendBtn = findViewById(R.id.add_buddy);
        chatBtn = findViewById(R.id.begin_chat);
        removeFriendBtn = findViewById(R.id.remove_buddy);
        birthdayLayout = findViewById(R.id.birthday);
        nickText = findViewById(R.id.user_nick);
        ...
        aliasLayout = findViewById(R.id.alias);
        ((TextView) birthdayLayout.findViewById(R.id.attribute)).setText("生日");
        ((TextView) phoneLayout.findViewById(R.id.attribute)).setText("手机");
        ((TextView) emailLayout.findViewById(R.id.attribute)).setText("邮箱");
        ((TextView) signatureLayout.findViewById(R.id.attribute)).setText("签名");
        ((TextView) aliasLayout.findViewById(R.id.attribute)).setText("备注名");
        ...
        aliasLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UserProfileEditItemActivity.startActivity(AddFriendActivity.this, KEY_ALIAS, account);
            }
        });
    }
    ...
    private void initActionbar() {
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //  UserProfileSettingActivity.start(AddFriendActivity.this, account);
            }
        });
    }
    ...
    private SwitchButton.OnChangedListener onChangedListener = new SwitchButton.OnChangedListener() {
        ...
        public void OnChanged(View v, final boolean checkState) {
            ...
            if (!NetworkUtil.isNetAvailable(AddFriendActivity.this)) {
            ...
            if (key.equals(KEY_BLACK_LIST)) {
                if (checkState) {
                    NIMClient.getService(FriendService.class).addToBlackList(account).setCallback(new RequestCallback<Void>() {
                        ...
                        public void onSuccess(Void param) {
                            Toast.makeText(AddFriendActivity.this, "加入黑名单成功", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    NIMClient.getService(FriendService.class).removeFromBlackList(account).setCallback(new RequestCallback<Void>() {
                        @Override
                        public void onSuccess(Void param) {
                            Toast.makeText(AddFriendActivity.this, "移除黑名单成功", Toast.LENGTH_SHORT).show();
                        }
                ...
                NIMClient.getService(FriendService.class).setMessageNotify(account, checkState).setCallback(new RequestCallback<Void>() {
                    ...
                    public void onSuccess(Void param) {
                        if (checkState) {
                            Toast.makeText(AddFriendActivity.this, "开启消息提醒成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AddFriendActivity.this, "关闭消息提醒成功", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void doAddFriend(String msg, boolean addDirectly) {
        ...
        if (!TextUtils.isEmpty(account) && account.equals(DemoCache.getAccount())) {
            Toast.makeText(AddFriendActivity.this, "不能加自己为好友", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .setCallback(new RequestCallback<Void>() {
                    ...
                    public void onSuccess(Void param) {
                        ...
                        if (VerifyType.DIRECT_ADD == verifyType) {
                            ...
                            Toast.makeText(AddFriendActivity.this, "添加好友请求发送成功", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailed(int code) {
                        DialogMaker.dismissProgressDialog();
                        if (code == 408) {
                            Toast.makeText(AddFriendActivity.this, R.string.network_is_not_available, Toast
                                    .LENGTH_SHORT).show();
                        } else {
                ...
                new EasyAlertDialogHelper.OnDialogActionListener() {
                    ...
                    public void doOkAction() {
                        ...
                        NIMClient.getService(FriendService.class).deleteFriend(account).setCallback(new RequestCallback<Void>() {
                            ...
                            public void onSuccess(Void param) {
                                DialogMaker.dismissProgressDialog();
                                Toast.makeText(AddFriendActivity.this, "删除好友成功", Toast.LENGTH_SHORT).show();
                                finish();
                            }
    ...
    private void onChat() {
        Log.i(TAG, "onChat");
        NimUIKit.startP2PSession(this, account, null);
    }
}
