...
import com.my.engine.common.clazz.NimGeocoder;
...
/*  */
public class LocationAmapActivity extends UI implements AMap.OnCameraChangeListener, View.OnClickListener
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.action_bar_right_clickable_textview) {
            sendLocation();
            finish();
        } else if (v.getId() == R.id.location_pin) {
            setPinInfoPanel(!isPinInfoPanelShow());
        } else if (v.getId() == R.id.location_info) {
